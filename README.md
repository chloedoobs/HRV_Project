...
Files should include `baseline` or `<number>bpm` in the filename. The code is set up to run 'P01' data, and can compare 'P02' results. Please update the participant numbers and associated .txt files. 

## Usage
1. For recreating the results from our data: Download the ZIP files (P01 & P02), ennsure that the pathway in the code matches the location you have stored the downloads in. 
